    ...
    <div class="container">
        ...
        <div class="left">
            <div class="photo-box">
                ...
                <img src="mjb.jpg" alt="Konversi Meja Bundar">
            </div>
        </div>

        <!-- KANAN -->
        <div class="right">
            <h2>Konferensi Meja Bundar</h2>

            <div class="stars">
                <span>★★★★<span class="unfilled-star">★</span></span>
            </div>

            <p>Konferensi Meja Bundar (KMB), dalam bahasa Belanda disebut Nederlands-Indonesische rondetafelconferentie, adalah sebuah konferensi yang diselenggarakan di Den Haag, Belanda, dari tanggal 23 Agustus hingga 2 November 1949. Konferensi ini dihadiri oleh perwakilan Kerajaan Belanda, Republik Indonesia, dan Majelis Permusyawaratan Federal yang mewakili berbagai negara bagian yang didirikan Belanda di kepulauan Indonesia. Konferensi ini berakhir dengan penyerahan kedaulatan kepada Republik Indonesia Serikat.<br><br>

                Sebelum KMB berlangsung, sudah ada tiga pertemuan tingkat tinggi antara Belanda dan Indonesia, yaitu Perundingan Linggajati pada tahun 1947, Perjanjian Renville pada tahun 1948, dan Perjanjian Roem-Royen pada tahun 1949.
            </p>

            <div class="button">
                <a class="btn" href="isiArtikelKonferensiMejaBundar.php">
                    Baca Selengkapnya
