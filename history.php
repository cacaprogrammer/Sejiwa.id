...
// Ambil riwayat baca dari database
$stmt2 = $conn->prepare("
    ...
    <div class="history-box">
      ...
      <table>
        ...
        <?php if ($histories->num_rows === 0): ?>
          <tr>
            <td colspan="5" class="kosong">Belum ada riwayat baca.</td>
          </tr>
        <?php else: ?>
          <?php while ($row = $histories->fetch_assoc()): ?>
            ...
            <tr>
              ...
              <td>
                <span class="badge selesai"><?= ucfirst($row['kategori']) ?></span>
              </td>
              <td>
                <a href="isi.php?slug=<?= urlencode($row['slug']) ?>" class="baca-link">Baca Sekarang</a>
              </td>
              <td><?= $tgl ?></td>
              <td>
