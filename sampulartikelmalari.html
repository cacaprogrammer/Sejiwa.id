    ...
    <div class="container">
        ...
        <div class="left">
            <div class="photo-box">
                ...
                <img src="mb.jpg" alt="Peristiwa Malari">
            </div>
        </div>

        <!-- BAGIAN KANAN -->
        <div class="right">
            <h2>Peristiwa Malari</h2>

            <div class="stars">
                <span>★★★<span class="unfilled-star">★★</span></span>
            </div>

            <p>Peristiwa Malari terjadi pada 15 Januari 1974 di Jakarta, yang merupakan demonstrasi besar mahasiswa dan masyarakat menentang kebijakan pemerintah terkait investasi asing dan korupsi. Aksi ini memuncak dengan kerusuhan di pusat kota dan menimbulkan perhatian nasional terhadap reformasi politik.</p>

            <p>Demonstrasi ini dikenal sebagai Malari (Malapetaka Lima Belas Januari) dan menjadi titik penting dalam sejarah politik Indonesia karena menegaskan peran mahasiswa sebagai agen perubahan sosial dan politik.</p>

            <p>Peristiwa Malari juga berdampak pada peninjauan ulang kebijakan pemerintah, termasuk evaluasi terhadap investasi asing, serta memperkuat kontrol pemerintah terhadap media dan organisasi masyarakat.</p>
