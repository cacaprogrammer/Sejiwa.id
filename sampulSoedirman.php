    ...
    <div class="container">
        ...
        <div class="left">
            <div class="photo-box">
                ...
                <img src="sdd.jpg" alt="Jendral Soedirman">
            </div>
        </div>

        <!-- KANAN -->
        <div class="right">
            <h2>Jendral Soedirman</h2>

            <p> Soedirman adalah seorang perwira tinggi Indonesia pada masa Revolusi Nasional Indonesia. Sebagai Panglima Besar Tentara Nasional Indonesia pertama, ia adalah sosok yang dihormati secara luas di Indonesia, dan pada tahun 1964 ia secara resmi ditetapkan sebagai Pahlawan Nasional Indonesia. 
            </p>
            <p> Terlahir dari pasangan rakyat biasa di Purbalingga, Soedirman diadopsi oleh pamannya yang seorang priyayi. Setelah keluarganya pindah ke Cilacap pada 1916, Soedirman tumbuh menjadi seorang siswa rajin; ia aktif dalam kegiatan ekstrakurikuler, termasuk program kepanduan yang dijalankan Muhammadiyah. Ia juga menunjukkan kemampuannya dalam memimpin dan berorganisasi. Soedirman sangat dihormati oleh masyarakat karena ketaatannya pada Islam. 
            </p>

            <div class="button">
                <a class="btn" href="isibiografiSoedirman.php">
                    Baca Selengkapnya
