...
// PERBAIKAN: Hapus pengecekan login yang memaksa redirect
// Hapus kode ini:
...
// Biarkan guest mengakses halaman ini
$isLoggedIn = isset($_SESSION['username']);

// Hitung notif hanya jika user login (untuk ditampilkan di navbar)
$_nb_count = 0;
...
<head>
    ...
    <title>View More - Sejiwa.id</title>
