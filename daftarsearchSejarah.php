...
// Ambil semua artikel kategori 'sejarah' yang published
$q = $conn->query("
...
<div class="article-grid" id="article-grid">
    <?php if (empty($list_artikel)): ?>
        <div class="empty-state">
            ...
            <p>Belum ada artikel sejarah yang dipublikasikan.</p>
        </div>
    <?php else: ?>
