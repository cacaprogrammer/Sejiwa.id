...
<head>
    ...
    <title>Peristiwa G30S/PKI</title>
    ...
    <div class="container">
        ...
        <div class="left">
            <div class="photo-box">
                ...
                <img src="g30.jpg" alt="Peristiwa G30S/PKI">
            </div>
        </div>

        <!-- BAGIAN KANAN -->
        <div class="right">
            <h2>Peristiwa G30S/PKI</h2>

            <div class="stars">
                <span>★★★★★<span class="unfilled-star"></span></span>
            </div>

            <p>Sebuah pengkhianatan terbesar yang dialami bangsa Indonesia, Gerakan 30 September 1965 / PKI atau G30S/PKI. Peristiwa ini terjadi pada malam hari tepat pergantian tanggal 30 September menjadi 1 Oktober 1965, melibatkan Pasukan Cakrabirawa dan anggota PKI.</p>

            <p>Gerakan ini bertujuan menggulingkan pemerintahan Presiden Soekarno dan menggantinya dengan pemerintahan komunis. G30S/PKI dipimpin oleh Dipa Nusantara Aidit (DN. Aidit), yang gencar memberikan hasutan agar masyarakat mendukung PKI dengan janji kemajuan Indonesia. Menurut pakar sejarah pada masa rezim Presiden Soeharto, DN. Aidit adalah dalang utama gerakan ini.</p>

            <div class="button">
                <a class="btn" href="isiartikelG30.php">
                    Baca Selengkapnya
