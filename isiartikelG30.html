...
<body>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu">
                        ...
                        <div class="dropdown-inner"><a href="daftarBiografi.php">Biografi Tokoh</a></div>
                    </div>
                </li>
        ...
        <div class="article-content">
            <div class="left-column">
                <div class="article-card-wrapper">
                    <div class="image-box">
                        <img src="g30.jpg" alt="Sampul Artikel G30S/PKI" class="main-article-image">
                    </div>
                    <div class="article-title-card">Peristiwa G30S/PKI</div>
                ...
                <!-- ✅ Tombol Rating — onclick bukaRating(), bukan <a href> langsung -->
            ...
            <div class="right-column-description" id="article-body">
                <p>Pada 30 September 2024, Indonesia memperingati peristiwa kelam yang
                dikenal sebagai Gerakan 30 September Partai Komunis Indonesia (G30S PKI)
                atau Gerakan September Kelabu (Gestapu). Sebanyak enam jenderal TNI dibunuh
                dalam pemberontakan G30S PKI. Lebih dari 59 tahun, peristiwa ini
                meninggalkan luka mendalam dalam sejarah Indonesia. Didirikannya
                Monumen Pancasila menjadi simbol peringatan G30S PKI. 
                Simak yuk serba-serbi peringatan G30S PKI yang dirangkum dari
                berbagai sumber. Meletusnya peristiwa G30S PKI didorong oleh
                persaingan politik antara PKI dan TNI, yang dipicu kekhawatiran
                atas kesehatan Presiden Soekarno yang menurun pada 1965. Saat
                Soekarno pingsan di awal Agustus setelah berpidato, spekulasi
                tentang siapa yang akan menggantikannya mulai muncul. PKI,
                sebagai kekuatan politik besar saat itu, merasa terancam oleh potensi
                peran dominan TNI dalam suksesi kepemimpinan. Ketegangan antara kedua
                pihak semakin meningkat karena tidak ada kejelasan tentang transisi
                kekuasaan di masa depan, yang akhirnya memuncak pada peristiwa berdarah G30S PKI.</p>
                <p>Peristiwa G30S PKI, yang dimulai pada 30 September 1965, berpusat pada
                penculikan dan pembunuhan enam jenderal TNI AD oleh pasukan Resimen
                Tjakrabirawa (pasukan penjaga Presiden Soekarno) di bawah pimpinan 
                Letkol Untung, dengan Lettu Dul Arief sebagai pelaksana.</p>
                <p>Para jenderal yang menjadi korban, seperti Letjen Ahmad Yani dan 
                Brigjen D.I. Panjaitan, dibunuh dan dimakamkan di Lubang Buaya. 
                Jenderal A.H. Nasution selamat, tetapi putrinya, Ade Irma Suryani, 
                terbunuh. PKI juga menguasai Radio Republik Indonesia (RRI) 
                untuk menyebarkan Dekrit No.1 yang mengklaim penyelamatan negara dari
                dewan jenderal yang hendak merebut kekuasaan. Gerakan ini meluas hingga
                Yogyakarta dan Jawa Tengah, dengan beberapa perwira lainnya, seperti Kolonel
                Katamso dan Letkol Sugiono, turut menjadi korban.</p>
                <p>Tujuan Pemberontakan G30S PKI :</p>
                <p>Tujuan utama G30S PKI adalah menggulingkan pemerintahan Presiden
                     Soekarno dan mengganti negara Indonesia menjadi negara komunis.
                      Dikutip dari buku Sejarah untuk SMK Kelas IX oleh Prawoto, berikut
                       tujuan G30S PKI yang lain:</p>
                <p>1. Menghancurkan Negara Kesatuan Republik Indonesia (NKRI) 
                    dan menjadikannya sebagai negara komunis
                    <br>2. Menyingkirkan TNI AD dan merebut kekuasaan pemerintahan
                    <br>3. Mewujudkan cita-cita PKI untuk menjadikan ideologi komunis dalam membentuk sistem pemerintahan
                    <br>4. Mengganti ideologi Pancasila menjadi ideologi komunis
                    <br>5. Kudeta yang dilakukan kepada Presiden Soekarno tak lepas dari rangkaian kegiatan komunisme internasional.</p>
                <p>Pasca Pemberontakan G30S PKI</p>
                <p>Setelah peristiwa G30S PKI menyebar, gelombang demonstrasi
                     anti-PKI melanda Jakarta. Pemerintah merespons dengan 
                     operasi penumpasan yang melibatkan penangkapan individu-individu
                      yang terlibat. Krisis ini mencapai puncaknya dengan dikeluarkannya
                       Surat Perintah 11 Maret 1966 (Supersemar) oleh Presiden Soekarno.
                       Surat tersebut diduga memberikan mandat
                        kepada Jenderal Soeharto untuk mengambil
                         langkah-langkah stabilisasi. Dengan wewenang
                          tersebut, Soeharto segera mengeluarkan kebijakan
                           tegas berupa pelarangan PKI dan organisasi massa
                            yang terkait dengan mereka, menandai awal dari
                             kejatuhan partai tersebut dan konsolidasi kekuasaan militer.
                    Selain itu mahasiswa melakukan demonstrasi dengan Tiga Tuntutan Rakyat (TRITURA),
                     yaitu membubarkan Partai Komunis Indonesia, perombakan Kabinet Dwikora, dan
                      turunkan harga kebutuhan pokok. Setelah desakan dari berbagai pihak, akhirnya
                       pada tanggal 7 Maret 1967, Majelis Permusyawaratan Rakyat Sementara (MPRS)
                        mencabut mandat Presiden Soekarno, dan menggantinya dengan Jenderal Soeharto.
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        // ============================================================
        // DATA ARTIKEL INI — khusus G30S/PKI
        // ============================================================
        const ARTIKEL_DATA = {
            id: 'g30s-pki',
            judul: 'Peristiwa G30S/PKI',
            gambar: 'g30.jpg',
            link: 'isiartikelG30.php'  // ✅ nama file yang benar
        };

        const FAVORIT_KEY = 'sejiwa_favorit';
        const AKTIF_KEY   = 'sejiwa_aktif_artikel';
        ...
        // ─── ✅ FUNGSI UTAMA: Simpan artikel G30S/PKI lalu buka rating.php ───
        function bukaRating() {
