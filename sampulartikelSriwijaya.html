    ...
    <div class="container">
        ...
        <div class="left">
            <div class="photo-box">
                ...
                <img src="jy.jpg" alt="Kerajaan Sriwijaya">
            </div>
        </div>

        <!-- KANAN -->
        <div class="right">
            <h2>Kerajaan Sriwijaya</h2>
            ...
            <p>
               [ belum diganti isi ]Sebuah pengkhianatan terbesar yang dialami bangsa Indonesia, Gerakan 30 September 1965 / PKI atau
                G30S/PKI. Peristiwa G 30 S PKI terjadi pada malam hari tepat waktunya saat pergantian dari tanggal 30
                Septemberhari Kamis, menjadi 1 Oktober pada hari Jumat tahun 1965 tepat tengah malam dengan melibatkan
                Pasukan Cakrabirawa dan Anggota Partai Komunis Indonesia (PKI).<br><br>

                Gerakan ini bertujuan menggulingkan pemerintahan Presiden Soekarno dan menginginkan pemerintahan
                Indonesia menjadi pemerintahan komunis. Gerakan 30 S PKI dipimpin oleh ketua saat itu, yaitu Dipa
                Nusantara Aidit atau sering dikenal dengan nama DN. Aidit. DN. Aidit gencar memberikan hasutan kepada
                seluruh masyarakat supaya mendukung PKI dengan iming-iming Indonesia akan lebih maju dan sentosa. DN.
                Aidit menurut pakar sejarah pada masa rezim Presiden Soeharto merupakan dalang utama gerakan 30 S PKI.
            </p>
