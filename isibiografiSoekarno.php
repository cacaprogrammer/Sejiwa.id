...
<div class="container">
  ...
  <h2>BIOGRAFI</h2>
  <span class="site-name-right">INFOHUKUM</span>
  <hr>
  ...
  <div class="content">
    ...
    <div class="left-card">
      ...
      <div class="person-name">Ir Soekarno</div>

      <img src="ir.jpg" class="photo">
      ...
      <table>
        <tr><td>Lahir</td><td>6 Juni 1901</td></tr>
        <tr><td>Meninggal</td><td>21 Juni 1970 (umur 69)</td></tr>
        <tr><td>Pekerjaan</td><td>Insinyur, politikus, guru</td></tr>
      </table>
    ...
    <div class="right" id="article-body">
      ...
      <p>Soekarno lahir di Peneleh, Surabaya, Jawa Timur, pada 6 Juni 1901 dengan nama Kusno.</p>

      <p>Ketika menjadi presiden, Soekarno mengganti ejaan namanya menjadi Sukarno.</p>

      <p>Ia adalah putra dari Raden Soekemi Sosrodihardjo dan Ida Ayu Nyoman Rai.</p>

      <p>Soekarno menempuh pendidikan di ELS dan HBS Surabaya.</p>

      <p>Ia melanjutkan pendidikan di Technische Hoogeschool te Bandoeng.</p>

      <p>Pada 17 Agustus 1945, Soekarno bersama Mohammad Hatta memproklamasikan kemerdekaan Indonesia.</p>

      <p>Soekarno menjadi presiden pertama Republik Indonesia sejak 1945 hingga 1967.</p>

      <p>Ia wafat pada 21 Juni 1970 dan dimakamkan di Blitar, Jawa Timur.</p>
