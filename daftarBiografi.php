...
<body>
    ...
    <div class="article-grid">
        ...
        <div class="card">
            <div class="card-title">Jendral Soedirman</div>
            <div class="card-image-wrapper">
                <img src="sd.jpg" alt="Jendral Soedirman" class="card-image">
            </div>
        ...
        <div class="card">
            <div class="card-title">R.A Kartini</div>
            <div class="card-image-wrapper">
                <img src="kr.jpg" alt="R.A Kartini" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Ahmad Yani </div>
            <div class="card-image-wrapper">
                <img src="ay.jpg" alt="Ahmad Yani" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Ir. Sukarno </div>
            <div class="card-image-wrapper">
                <img src="tokoh3.jpg" alt="Ir. Sukarno" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Dr.Soetomo</div>
            <div class="card-image-wrapper">
                <img src="tokoh5.jpg" alt="Dr.Soetomo" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Ki Hajar Dewantara</div>
            <div class="card-image-wrapper">
                <img src="ki.jpg" alt="Ki Hajar Dewantara" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Mohammad Hatta</div>
            <div class="card-image-wrapper">
                <img src="tokoh4.jpg" alt="Mohammad Hatta" class="card-image">
            </div>
            <div class="card-footer">
                <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
        ...
        <div class="card">
            <div class="card-title">Bung Tomo</div>
            <div class="card-image-wrapper">
                <img src="tokoh1.jpg" alt="Bung Tomo" class="card-image">
            </div>
            <div class="card-footer">
            <span class="card-year">2025</span>
                <a href="#" class="read-button">Baca Sekarang <img src="majesticons_arrow-right.png"> </a>
